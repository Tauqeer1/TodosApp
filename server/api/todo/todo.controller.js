...
export function index(req, res) {
  return Todo.find({userId: req.params.userId}).exec()
...
export function upsert(req, res) {
  ...
  return Todo.findOneAndUpdate(req.params.id, req.body, {upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
